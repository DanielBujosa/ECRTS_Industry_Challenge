...
% Guardar .mat
save('Experiment0/BE_Messages.mat', 'BE_Messages');
save('Experiment0/AVB_Messages.mat', 'AVB_Messages');
save('Experiment0/TT_Messages.mat', 'TT_Messages');
save('Experiment0/Architecture.mat', 'Architecture');
save('Experiment0/Routes.mat', 'Routes');

%WRITE ST SCHEDULER INPUT FILE

fid = fopen('Experiment0/STHS_input.txt','wt');
